...
INSERT INTO hms.complaints (title, student_id, complaint_category_id, datetime, description, status, starred, feedback, appointment_date_pref, appointment_from_time_pref, appointment_to_time_pref) VALUES ('AC not working', 1, 5, '2018-08-29 11:00:00.972000', 'The indicator lights on the AC start blinking whenever I turn it on, and then they go off in a few minutes.', 2, '0', 'Everything works fine now', '2018-08-30', '13:00:00', '14:00:00');
INSERT INTO hms.complaints (title, student_id, complaint_category_id, datetime, description, status, starred, feedback, appointment_date_pref, appointment_from_time_pref, appointment_to_time_pref) VALUES ('Router not working', 1, 4, '2018-09-15 12:00:00.141000', 'The Wifi disconnects within 5 minutes when I try to connect. This happens every single time. Mostly it shows "disconnected by admin", but it even disconnects without any message sometimes, even when using the Network Client on Windows. Updated the network drivers as suggest, but the problem still persists.', 1, '1', null, '2018-09-16', '12:00:00', '13:00:00');
INSERT INTO hms.complaints (title, student_id, complaint_category_id, datetime, description, status, starred, feedback, appointment_date_pref, appointment_from_time_pref, appointment_to_time_pref) VALUES ('Door handle broken', 1, 1, '2018-10-04 15:00:00.390000', 'The door handle is jammed. Tried to oil it but didn''t work out.', 2, '0', 'The handle has been fixed now', '2018-10-06', '10:00:00', '11:00:00');
INSERT INTO hms.complaints (title, student_id, complaint_category_id, datetime, description, status, starred, feedback, appointment_date_pref, appointment_from_time_pref, appointment_to_time_pref) VALUES ('Washing machine not working', 1, 3, '2018-10-20 19:15:00.059000', 'When I put my clothes in, the machine was working fine. But when I went to take them out after about an hour, the clothes were completely dry and it looked like the machine didn''t run at all.', 1, '0', null, null, null, null);
INSERT INTO hms.complaints (title, student_id, complaint_category_id, datetime, description, status, starred, feedback, appointment_date_pref, appointment_from_time_pref, appointment_to_time_pref) VALUES ('Water tap leaking', 1, 2, '2018-10-24 08:45:00.037000', 'The tap has been leaking since 6 in the morning.', 0, '1', null, '2018-10-24', '12:15:00', '13:00:00');

INSERT INTO hms.appointments (complaint_id, date, from_time, to_time) VALUES (1, '2018-08-30', '13:00:00', '14:00:00');
INSERT INTO hms.appointments (complaint_id, date, from_time, to_time) VALUES (2, '2018-09-16', '12:00:00', '13:00:00');
INSERT INTO hms.appointments (complaint_id, date, from_time, to_time) VALUES (3, '2018-10-06', '10:00:00', '11:00:00');